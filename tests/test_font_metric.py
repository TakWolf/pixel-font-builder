...
def test_copy():
    ...
    font_metric_2 = copy(font_metric_1)

    assert font_metric_1 == font_metric_2
    assert font_metric_1 is not font_metric_2
    assert font_metric_1.horizontal_layout is font_metric_2.horizontal_layout
...
def test_deepcopy():
    ...
    font_metric_2 = deepcopy(font_metric_1)

    assert font_metric_1 == font_metric_2
    assert font_metric_1 is not font_metric_2
    assert font_metric_1.horizontal_layout is not font_metric_2.horizontal_layout
